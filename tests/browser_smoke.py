...
try:
    with sync_playwright() as p:
        ...
        page.goto(base+'/?mode=single');page.wait_for_selector('#deploy');ready()
        ...
        assert page.evaluate("[...document.querySelectorAll('header nav button, main button, dialog button')].every(b=>b.title && (b.querySelector('svg,img,.item-art,.portrait')!==null))")
