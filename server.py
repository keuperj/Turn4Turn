...
class Handler(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        if path.startswith('/sounds/'):
            ...
            return
        if path.startswith(('/assets/','/vendor/')) or path in ('/scene.js','/urban.js','/background.js','/transport.js','/rendering.js','/characters.js','/environment.js','/icons.js','/minimap.js','/loading-guide.js','/audio.js','/webgpu-check.js','/webgpu-quality.js','/webgpu-nature.js','/webgpu-vehicles.js','/webgpu-scenery.js'):
