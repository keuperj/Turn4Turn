...
are recorded in `transport/manifest.json`; see `transport/LICENSE-airport.txt`.
...
Source URLs, SHA-256 hashes, dimensions and licensing are recorded in the transport
manifest and `transport/LICENSE-factory.txt`.
