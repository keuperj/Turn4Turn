"""Rebuild the bundled Quaternius transports from FBX sources using Playwright.

Usage: .venv/bin/python tools/import_transport.py /path/to/source-fbx
...
def main():
    ...
    if args.download:
        ...
        sources.append(('Zombie_Atlas.png', manifest['textureSource']))
    ...
    class Handler(SimpleHTTPRequestHandler):
        ...
        def translate_path(self, path):
            ...
            if path == '/transport-convert.js':
                return str(ROOT / 'tools/transport-convert.js')
